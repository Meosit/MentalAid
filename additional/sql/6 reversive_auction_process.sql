...
UPDATE `lot` SET `status` = 1 WHERE `id` = 3; 

-- lot published by it's owner
UPDATE `lot` SET `status` = 2 WHERE `id` = 3; 

-- After some time system decreases current price
SELECT sleep(5); -- Time calculates based on 
UPDATE `lot` SET `current_price` = 280 WHERE `id` = 3;

-- After some time system decreases current price
SELECT sleep(5); -- Time calculates based on 
UPDATE `lot` SET `current_price` = 260 WHERE `id` = 3;

-- After some time system decreases current price
SELECT sleep(5); -- Time calculates based on 
UPDATE `lot` SET `current_price` = 240 WHERE `id` = 3;
